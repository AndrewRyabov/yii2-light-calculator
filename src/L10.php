...
const L10_BB19_K_PVHPerehTolsh45KK_m = 0.61; // пвх, переход толщины 4/5 козырек/крыша, м

const L10_BB24_K_AkrylPerehodTolsh23Ulica_m = 0.61; // акрил, переход толщины 2/3 улица, м
const L10_BB25_K_AkrylPerehodTolsh23Pomesh_m = 0.9; // акрил, переход толщины 2/3 помещение, м

const L10_BB28_K_PolicarbPerehTolsh46UlicaB_m = 4; // поликарбонат, переход толщины 4/6 улица (больший размер), м
const L10_BB29_K_PolicarbPerehTolsh46UlicaM_m = 0.8; // поликарбонат, переход толщины 4/6 улица (меньший размер), м
...
const L10_BB38_K_OpirPloshK_m2 = 1; // опираемая площадь козырек, м2
...
const L10_BB47_K_PVH5mmMaxNagrNaPodv_kg = 8; // пвх 5 мм, мах нагрузка на подвес, кг
const L10_BB48_K_DVP3mmMaxNagrNaPodv_kg = 8; // двп 3 мм, мах нагрузка на подвес, кг
const L10_BB49_K_GranPrimPodvOD_m = 1; // граница применения подвеса одинарный/двойной, м
const L10_BB50_K_DlnTrosDlVnutPodv_mp = 6; // длина троса для внутреннего подвеса, мп

const L10_BB52_K_KolSticovTila1mp = 0.3; // количество стыков тыла / 1 мп
const L10_BB53_K_KolSticovBorta1mp = 0.3; // количество стыков борта / 1 мп

const L10_BB56_K_PererashTrubaBlack_20x20_40x20 = 1.1; // перерасход трубы черн. 20*20, 40*20
const L10_BB57_K_PererashUgolAL_12x12_15x15 = 1.1; // перерасход углок AL 12*12, 15*15
const L10_BB58_K_PererashCDUD = 1.2; // перерасход CD/UD
const L10_BB59_K_PererashStilkoProf = 1.2; // перерасход "Стилко" профиль
const L10_BB60_K_KolSamorezVZadStShtMp = 4; // количество саморезов в задней стенке шт./ мп
const L10_BB61_K_KolSamorezVRamaPVHKorobShtMp = 5; // количество саморезов в рама- пвх короб  шт./ мп
const L10_BB62_K_KolSamorezVALRamaPVHKorobShtMp = 4; // количество саморезов в AL рама - пвх короб (4 стороны) шт./ мп

const L10_BB65_K_KoefPererashALDiodPolos = 1.2; // коэф. перерасхода AL диод. полосы
const L10_BB65_K_KoefPererashGibkDiodPolos = 1.1; // коэф. перерасхода гибкой диод. полосы
...
const L10_BB70_K_PredkolKlast37503KrVSegmsht = 50; // предельное количество кластеров 3750, 3 кр. в сегменте, шт
const L10_BB71_K_PredDlnLentDiod3750144VtVSegmm = 5; // предельная длина ленты диодной 3750, 14.4 Вт в сегменте, м
...
const L10_BB76_K_ShagLinGibkPolos_m = 0.22; // шаг линий гибких полос, м
...
const L10_BB79_K_GarantFinansNaBP = 1.1; // коэф гарантийно-финансовый на БП
const L10_BB80_K_DlnLampMontProvodPV1 = 3.5; // коэф длина ламп/монт провод ПВ1
...
const L10_BB100_K_RashSkotchStreych = 1; // коэф расхода скотч/стрейч
...
const L10_BB104_K_ShagStyajDerPlanoksht1mpPerimFasad = 3; // шаг стяжных дер планок шт/1 мп периметра фасада
const L10_BB105_K_PererashDerPlanokupak = 1.15; // коэф перерасхода деревянных планок "упаковочных"
...
const L10_BB111_K_KolPoezdSnabjBezPlankStandartsht = 2; // количество поездок снабженца (без пленки) стандарт, шт
const L10_BB112_K_KolPoezdSnabjPlenkStandartsht = 1; // количество поездок снабженца (пленка) стандарт, шт
const L10_BB113_K_ProbegDobloZa1PoezdSnabj100km = 0.2; // пробег "Doblo" за 1 поездку снабженца, 100 км

const L10_BB115_K_ZatratnaDostListMatlDis = 1.5; // затраты на доставку листовых материалов, л дизель
...
const L10_BT8_RaskrPVHPogon_1mp = 1.5; // раскрой пвх погонаж, 1 мп
const L10_BT9_RaskrDVPUpak_1mp = 2; // раскрой двп упаковочного, 1 мп
const L10_BT10_PrirezTrosStal_1mp = 3; // прирезать трос стальной, 1 шт
...
const L10_BT17_Skl1mp1Ugol4StorViv_min = 30; // склейка 1 мп 1 угла 4 сторонней вывески, мин
const L10_BT18_Skl1Ugol4StorVivMinim_min = 2; // склейка 1 угла 4 сторонней вывески минимум, мин

const L10_BT20_PriresChernStalProkatTrubaUgol_1sht = 4; // прирезка черного сталь проката (труба, уголок), 1 шт.
const L10_BT21_PriresStalProfCDUDStilk_1sht = 3.5; // прирезка сталь профиля (CD, UD, Стилко), 1 шт.
const L10_BT22_PriresPlankDerUpak_min = 1.5; // прирезка планки деревянной "упаковочной", мин

const L10_BT25_VkruchSamorez_1sht = 2; // вкручивание самореза, 1 шт.
const L10_BT26_VkruchSeriiSamorezov_1sht = 0.7; // вкручивание серии саморезов, 1 шт.
const L10_BT27_SverlOtvDo5mm_1sht = 2; // сверление отверстия до 5 мм, 1 шт.
const L10_BT28_SverlOtvBol5mm_1sht = 4; // сверление отверстия более 5 мм, 1 шт.
const L10_BT29_Sverl1OtvIzSer_min = 0.8; // сверление 1 отверстия из серии, мин
...
const L10_BT34_KnurlRitramaHalfCat_m2 = 40; // "Ritrama" с полупрорезом, накатать/выбрать , 1 м2
...
const L10_BT55_MontajBlockPit_1sht = 20; // монтаж блока питания, 1 шт.
const L10_BT56_MontajLamp_1sht = 20; // монтаж лампы, 1 шт.
const L10_BT57_MontajKlast_1sht = 1.2; // монтаж кластера, 1 шт.
const L10_BT58_MontajALDiodLin_1mp = 12; // монтаж AL диодной линии, 1 мп
const L10_BT59_MontajGibkDiodPolos_1mp = 6; // монтаж гибкой диодной полосы, 1 мп
const L10_BT60_MinVremMontajLentDiod_min = 15; // минимальное время монтажа ленты диодной, мин

const L10_BT65_MinTrudUpakVStreych_min = 5; // минимальная трудоемкость упаковки в стрейч, мин
const L10_BT66_UpakVStrech_1m2 = 2.5; // упаковка в стрейч, 1 м2
const L10_BT67_UpakVGofrokart_1m2 = 15; // упаковка в гофрокартон, 1 м2

const L10_BT75_SnabjStandartVives1i8m2 = 90; // снабжение, стандартная вывеска (1.8 м2)
const L10_BT76_EzdPoGorodu_minNAkm = 3; // езда по городу, мин/км
const L10_BT77_EzdZaGorodom_minNAkm = 1.2; // езда за городом, мин/км

const L10_BT80_ZagrOformVigrPosAvtodost_min = 30; // загрузка/оформление/выгрузка посылки автодоставка, мин
