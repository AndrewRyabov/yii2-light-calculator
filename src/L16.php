...
class L16
{
...

    {
        ...
        $this->B11_BigStor = $L09->J22_MaxSide_cm;
        $this->B12_SmallStor = $L09->J23_MinSide_cm;

        $this->B14_PlastikLicevoy = $L09->J40_PlasticFront;

        // борт пвх
        $this->S5_RoofVisorOut = $L09->J4_RoofVisorOut;
        $this->S6_WallOut = $L09->J5_WallOut;
        $this->S7_WallIn = $L09->J6_WallIn;
        $this->S8_2SideIn = $L09->J7_2SideIn;
        $this->S9_4SideIn = $L09->J8_4SideIn;

        $this->S11_Orientation = $L09->J21_Orientation;
        $this->S12_BigStor = $L09->J22_MaxSide_cm;
        $this->S13_SmallStor = $L09->J23_MinSide_cm;

        $this->S15_PlastikLicevoy = $L09->J40_PlasticFront;

        // тыл пвх/двп
        $this->AJ5_RoofVisorOut = $L09->J4_RoofVisorOut;
        $this->AJ6_WallOut = $L09->J5_WallOut;
        $this->AJ7_WallIn = $L09->J6_WallIn;
        $this->AJ8_2SideIn = $L09->J7_2SideIn;
        $this->AJ9_4SideIn = $L09->J8_4SideIn;

        $this->AJ12_BigStor = $L09->J22_MaxSide_cm;
        $this->AJ13_SmallStor = $L09->J23_MinSide_cm;
    }
