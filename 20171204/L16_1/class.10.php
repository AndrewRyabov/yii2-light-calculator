...
const L10_C8_Dizel = 23; // дизель 1 л
...
const L10_C28_Samorez19 = 0.2; // саморез 19 мм, цинк, бур
...
const L10_J44_RaskrDVPS = C24_CatDvp; // раскрой двп (стоимость)
...
const L10_K123_Silicon_300mlE = L10_C6_Dollar*2; // клей "секунда" (емкость)
...
const L10_U117_Gazel_grn = L10_V117_Gazel_l100km * L10_C8_Dizel;

const L10_V118_Doblo_l100km = 12;
const L10_U118_Doblo_grn = L10_V118_Doblo_l100km * L10_C8_Dizel;
...
const L10_AR23_ProfileCD_05mm = L10_C23_DvpWhite3mm/3 ; // профиль CD  0.5 мм (стоимость 1 шт/мп, грн)
...
const L10_BB61_K_KolSamorezVRamaPVHKorobShtMp = 4; // количество саморезов в рама- пвх короб  шт./ мп
...
const L10_BT26_VkruchSeriiSamorezov_1sht = 1.5; // вкручивание серии саморезов, 1 шт.
