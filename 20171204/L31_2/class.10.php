...
const L10_U97_DVPUpak = 0.52*L10_J28_DVPWhiteS; // двп упаковочное
...
const L10_AS48_Kronsht_4x4 = 0.3 ; // кронштейн "4*4" (вес 1 шт/мп,кг)
...
const L10_BB105_K_PererashDerevPlanok = 1.15; // коэф перерасхода деревянных планок
...
const L10_BB122_PredGorRazmNerazb4StorVivesm = 1; // предельный гор размер не разборности 4 стор вывески, м
const L10_BB123_PredGorRazmDlRamaIz4Uglm = 1; // пред гориз размер для рамы из 4 уг, м
const L10_BB124_PredGorRazmDlRamaIz20x20mmM = 2; // пред гор размер для  рамы из 20*20 мм, м
...
const L10_BT22_PrirezPlankDerUpak_min = 2; // прирезка планки деревяннной (упаковка), мин
