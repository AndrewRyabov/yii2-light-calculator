...
const L10_BB104_ShagStyazhDerPlanokshtNa1mpPerFasad = 3; // шаг стяжных дер планок шт/1 мп периметра фасада
...
const L10_BB124_PredGorRazmGlRamIz2020mmVm = 2; // пред гор размер для  рамы из 20*20 мм, м
...
const L10_BT66_UpakVStrech_1m2 = 1.8; // упаковка в стрейч, 1 м2
