...
const L10_U92_PlankaDerevo20x20 = 5; // планка дерево 20*20

const L10_U97_DvpYpakovochnoe = 0.52*L10_J28_DVPWhiteS; // двп упаковочное
...
const L10_U120_GazelDostavkaKNP_grn = 8 * L10_C10_Dizel;
const L10_U121_DobloDostavkaKNP_km = 15;

const L10_V122_GazeProbeg_l100km = 23;
const L10_U122_GazeProbeg_grn100km = L10_V122_GazeProbeg_l100km*L10_C10_Dizel;

const L10_V123_DobloProbeg_l100km = 10;
const L10_U123_DobloProbeg_grn100km = L10_V123_DobloProbeg_l100km*L10_C10_Dizel;

const L10_U126_EmkostGazel_m3_grn100km = 8;
const L10_U127_EmkostDoblo_m3_grn100km = 2.5;
...
const L10_AF30_PowerSupply_504BT_IP20S = 26.4*L10_C6_Dollar; // блок питания 504 ВТ, IP20
const L10_AG30_PowerSupply_504BT_IP20V = 1.1; //блок питания 504 ВТ, IP20
...
const L10_AI57_Claster3750_3kr_IP65P = 1.4; // кластер 3750, 3 кр., IP65 (потребление 1 шт/мп, Вт)
...
const L10_AG59_LentaPlastik3750_IP20V = 0.04; // лента пластик 3750, IP20 (вес 1 шт/мп, кг)
const L10_AH59_LentaPlastik3750_IP65R = 6000; // лента пластик 3750, IP20 (размер в сборе, мм)
const L10_AI59_LentaPlastik3750_IP65P = 14.4; // лента пластик 3750, IP20 (потребление 1 шт/мп, Вт)

const L10_AF60_ConnectorForAE57S = 0.35*L10_C6_Dollar; // соеденитель для AE 57 (стоимость 1 шт/мп, грн)
const L10_AG60_ConnectorForAE57V = 0.02; // соеденитель для AE 57 (вес 1 шт/мп, кг)

const L10_AF61_FinishForAE57S = 0.5*L10_C6_Dollar; // финиш для AE 57 (стоимость 1 шт/мп, грн)
const L10_AG61_FinishForAE57V = 0.02; // финиш для AE 57 (вес 1 шт/мп, кг)
...
const L10_AF81_ProvodPV1_05mm = 0.32*L10_AF79_CabelCu_1mm2_13A; // провод ПВ1,  0,5 мм (стоимость 1 шт/мп, грн)
const L10_AF82_ProvodPV1_075mm = 0.45*L10_AF79_CabelCu_1mm2_13A; // провод ПВ1,  0,75 мм (стоимость 1 шт/мп, грн)
const L10_AF83_ProvodPV1_1mm = 0.6*L10_AF79_CabelCu_1mm2_13A; // провод ПВ1,  1 мм (стоимость 1 шт/мп, грн)
...
const L10_AR32_StilcoProfil_12301214mm = L10_AR23_ProfileCD_05mm*1.3 ; // Стилко профиль 12*30*12*1.4 мм (стоимость 1 шт/мп, грн)

const L10_AS32_StilcoProfil_12301214mmV = 0.6 ; // Стилко профиль 12*30*12*1.4 мм (вес 1 шт/мп, кг)
...
const L10_AS51_kronshteynUhoV = 0.08 ; // кронштейн "ухо" (вес 1 шт/мп, кг)


const L10_AR52_Koush = L10_AR23_ProfileCD_05mm/9 ; // "коуш" (стоимость 1 шт/мп, грн)

const L10_AR53_BoltKruk = L10_AR38_BoltMetrichM8x50PlusGaika*2 ; // "болт-крюк" (стоимость 1 шт/мп, грн)

const L10_AS53_BoltKruk = 0.1 ; // "болт-крюк" (вес 1 шт/мп, кг)
...
const L10_BB10_K_PererashodDVPYpakovochnoe = 1.2; // перерасход  двп упаковочное
...
const L10_BB66_K_KoefPererashGibkDiodPolos = 1.05; // коэф. перерасхода гибкой диод. полосы
...
const L10_BB78_K_ZapasPoTokuDlBP = 1.24; // коэф запаса по току для БП

const L10_BB79_GarantKoefNaBP = 1.2; //гарантийный коэф на БП
...
const L10_BB105_K_PererashDerevanixPlanok = 1.15; // коэф перерасхода деревянных плано
...
const L10_BB111_K_KolichestvoPoezdokSnabjencaBezPlenkiStandart = 2;//количество поездок снабженца (без пленки) 

const L10_BB112_K_KolichestvoPoezdokSnabjencaPlenkaStandart=1;//количество поездок снабженца (пленка) стандарт, шт

const L10_BB113_K_ProbegDobloZa1PoezdkySnabjenca =0.15; //пробег "Doblo" за 1 поездку снабженца, 100 км

const L10_BB114_K_ProbAvtSnabj100kmVivesStandart = 10; // пробег авто снабженца 100 км/ вывеска стандарт

const L10_BB115_K_NaDostavkyListovixMaterialov_LDizel=1.5;//затраты на доставку листовых материалов, л дизель
...
const L10_BT9_RaskroiDvpYpakovochnogo_1mp = 2; // раскрой двп упаковочного, 1 мп

const L10_BT11_Montag2Zagimov_min = 6;//монтаж 2 зажимов, мин

const L10_BT12_Montag1BoltKrukI2Zagima_min = 10;//монтаж 1 болт-крюка + 2 зажимов, мин

const L10_BT13_Montag1LegkogoPodvesa_min = 12;//монтаж 1 "легкого" подвеса, мин
...
const L10_BT22_PrirezkaPlankiDerevenoiiYpakovka_min = 2; // прирезка планки деревяннной (упаковка), мин



const L10_BT25_VkruchSamorez_1sht = 2; // вкручивание самореза, 1 шт.
const L10_BT26_VkruchSeriiSamorezov_1sht = 0.8; // вкручивание серии саморезов, 1 шт.
...
const L10_BT80_ZagrOformVigruzkaPosAvtodostmin = 30; // загрузка/оформление/выгрузка посылки автодоставка, мин
const L10_BT81_ZagryzkaOformlenieVigryzkaPosilkiDlaNP_min = 45; // загрузка/оформление/выгрузка посылки для НП, мин

const L10_BT82_ZagrOformVigPosilokNachinaaSo2_min = 10; // заг/оформ/выг посылок начиная со 2й, мин
